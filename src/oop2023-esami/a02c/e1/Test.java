...
public class Test {
	 ...
	 * dipendentemente dall'implementazione. Fornisce quindi in generale n
	 * soluzioni,
	...
	public void testDuplicateFirst() {
		// un replacer che duplica la prima occorrenza di un certo numero, quindi
		// fornisce 0 o 1 soluzione
	...
	public void testTranslateLastWith() {
		// un replacer che sostituisce all'ultima occorrenza di un certo numero, una
		// certa sottolista (-1, -1)
	...
	public void testRemoveEach() {
		// un replacer che rimuove una a una ogni occorrenza di un certo numero, dando n
		...
		assertEquals(List.of(
				List.of(0, 20, 10),
				List.of(0, 10, 20)), replacer.replace(List.of(0, 10, 20, 10), 10));
		// L'11 non c'è, nessuna soluzione
		assertEquals(List.of(), replacer.replace(List.of(0, 10, 20, 10), 11));
	}
	...
	public void testReplaceEachFromSequence() {
		// le prime 3 occorrenze del numero sono rimpiazzate da -100, -101 e -102,
		// rispettivamente
		...
		assertEquals(List.of(
				List.of(0, -100, 20, 10),
				List.of(0, 10, 20, -101)), replacer.replace(List.of(0, 10, 20, 10), 10));
		// 3 occorrenze...
		assertEquals(List.of(
				List.of(-100, 10, 10, 10),
				List.of(10, -101, 10, 10),
				List.of(10, 10, -102, 10)), replacer.replace(List.of(10, 10, 10, 10), 10));
		// 0 occorrenze...
		assertEquals(List.of(), replacer.replace(List.of(0, 10, 20, 10), 11));
	}
}