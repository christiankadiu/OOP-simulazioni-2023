...
public class Test {
	 ...
	 * possibilità di accedere ad un certo punto di una struttura dati (anche
	 * complessa)
	...
	public void testDoubleIndexer() {
		...
		// getter e copy-setter sull'elemento di riga 2 e colonna 1 di una lista di
		// liste (matrice)
	...
	public void testRightRightAtPos() {
		...
		// getter e setter che accedono ad una sottoparte "profonda" di una lista di
		// pair di pair
