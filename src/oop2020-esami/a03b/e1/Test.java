...
public class Test {
	...
	/*
	 * Implementare l'interfaccia EquivalenceFactory come indicato nel metodo
	 * initFactory
	 * qui sotto. Realizza una factory per delle Equivalence, ossia degli oggetti
	 * che implementano
	 * delle relazioni binarie di equivalenza fra valori. Si ricordi che una
	 * relazione di equivalenza definisce
	 * in pratica una partizione sui valori, definendo dei sottogruppi (che non si
	 * intersecano): gli elementi
	...
	public void testFromPartition() {
		// equivalenza su [0..9], "siamo equivalenti se abbiamo lo stesso resto
		// divendendoci per 3"
	...
	public void optionalTestSmaller() {
		...
		// eq2 è ottenuta "spezzando i set" di eq, e quindi è più fine, ossia "smaller",
		// eccetera per gli altri
