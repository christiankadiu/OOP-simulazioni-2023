...
public class Test {
	...
	/*
	 * Implementare l'interfaccia CirclerFactory come indicato nel metodo
	 * initFactory qui sotto.
	 * Realizza una factory per dei Circler<T>, ossia oggetti con funzionalità per
	 * iterare i dati
	 ...
	 * punteggio:
	 * 
	 * - i metodi stayToLastSkipOne e alternateSkipOne (i cui test cominciano con
	 * "optional...")
	 * 
