...
public class Test {
	...
	/*
	 * Implementare l'interfaccia DeterministicParserFactory come indicato nel
	 * metodo
	 * initFactory qui sotto. Realizza una factory per dei DeterministicParser,
	 * ossia
	 * dei parser di vario tipo, che analizzano liste di token (stringhe) per capire
	 * se hanno la struttura ricercata. Si noti che il design di questi parser è
	 * pensato per
	 ...
	 * punteggio:
	 * 
	 * - implementazione dei cinque metodi nella factory (ossia, nella parte
	 ...
	 * 
	 * - correttezza della parte obbligatoria: 10 punti (2+2+3+3 per i metodi di
	 * factory necessari)
	 * 
	 * - correttezza della parte opzionale: 3 punti (metodo ulteriore)
	 * 
	 * - qualità della soluzione: 4 punti (per soluzione che minimizza le
	 * ripetizioni e che segue buone prassi di programmazione)
	 * 
	 */
	...
	public void testIncreasingSequence() {
		...
		assertEquals(Optional.of(List.of("-5", "20", "30", "-5", "7")),
				dp.accepts(List.of("-5", "20", "30", "-5", "7")));
