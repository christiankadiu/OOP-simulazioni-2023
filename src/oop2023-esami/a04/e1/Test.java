...
public class Test {
	 ...
	 * - la buona progettazione della soluzione, utilizzando per tutte le varie
	 * versioni
	...
	public void testCollectUntil() {
		final ListExtractor<Integer, List<Integer>> le = this.factory.<Integer, Integer>collectUntil(x -> x + 1,
				x -> x >= 30);
		// raccoglie gli elementi della lista finché non raggiungono il 30, sommando uno
		// ad ognuno
	...
	public void testScanFrom() {
		...
		// raccoglie gli elementi da quando ce ne è uno >= 30 fino in fondo, producendo
		// liste di liste incrementali
		assertEquals(List.of(List.of(30), List.of(30, 20), List.of(30, 20, 50)),
				le.extract(List.of(10, 20, 30, 20, 50)));
