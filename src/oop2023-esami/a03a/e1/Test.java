...
public class Test {
	 ...
	 * initFactory qui sotto. Realizza una factory per un concetto di Windowing,
	 * ossia
	...
	public void testPairing() {
		...
		// gli ultimi due input forniti a process formano un pair, la prima volta
		// Optional.empty
	...
	public void testSumFour() {
		...
		// gli ultimi quattro input forniti a process producono la loro somma, le prime
		// 3 volte Optional.empty
		assertEquals(Optional.empty(), windowing.process(1));
	...
	public void testLastN() {
		...
		// gli ultimi N input forniti a process producono una lista, le prime N-1 volte
		// Optional.empty
		assertEquals(Optional.empty(), windowing.process(1));
		assertEquals(Optional.empty(), windowing.process(10));
		assertEquals(Optional.empty(), windowing.process(100));
	...
	public void testSumAtLeast() {
		...
		// la lista degli ultimi elementi la cui somma è almeno N (N=10 in questo caso)
		// producono una lista
