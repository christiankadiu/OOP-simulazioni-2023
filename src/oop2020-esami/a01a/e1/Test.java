...
public class Test {
	...
	/*
	 * Implementare l'interfaccia TreeFactory come indicato nel metodo initFactory
	 * qui sotto.
	 * Realizza una factory per dei Tree, ossia strutture dati albero immutabile (un
	 * nodo ha "n" figli ordinati).
	 * Implementare correttamente (via Eclipse come al solito) i metodi equals e
	 * hashcode per questi Tree.
	 * 
	 ...
	 * - implementazione dei test chiamati optionalTestXYZ (relativi al toString e a
	 * twoChains)
	 ...
	 * - correttezza della parte opzionale: 4 punti (2 per i toString, 2 per
	 * twoChains
	...
	public void testOneLevel() {
		...
		// assertEquals("10[11[], 12[], 13[]]", tree.toString()); // STESSO TEST IN
		// optionalTestToString
	}
	...
	public void testTwoChildren() {
		...
		// assertEquals("1[10[11[], 12[]], 20[]]", tree.toString()); // STESSO TEST IN
		// optionalTestToString
	}
	...
	public void optionalTestChain() {
		...
		assertEquals(Integer.valueOf(30), tree.getChildren().get(0).getChildren().get(0).getRoot()); // radice del
																										// figlio del
																										// figlio
		...
		// assertEquals("10[20[30[]]]", tree.toString()); // STESSO TEST IN
		// optionalTestToString
	}
