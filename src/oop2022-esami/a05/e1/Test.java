...
/**
 * Si consulti la documentazione della interfaccia ExpressionParserFactory, che
 * modella
 * una factory per ExpressionParser, che a sua volta modella un parser
 * (riconoscitore) di
 * una espressione matematica (somme di numeri con parentesi, in generale),
 * ricevuta
 * elemento per elemento (da sinistra a destra) attraverso chiamate di metodo
 * successive.
 * 
 ...
 * punteggio:
 * - implementazione del quarto metodo factory (ossia, a scelta se ne realizzino
 * 3)
