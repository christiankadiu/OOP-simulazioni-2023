...
/**
 * Si consulti la documentazione della interfaccia ListSplitterFactory, che
 * modella
 * una factory per ListSplitter, che a sua volta modella un trasformatore da
 * liste a
...
public class Test {
	...
	public void testAsTripletsWithRest() {
		...
		assertEquals(List.of(List.of(1, 2, 3), List.of(4, 5, 6)), ls.split(List.of(1, 2, 3, 4, 5, 6)));
		assertEquals(List.of(List.of(1, 2, 3), List.of(4, 5, 6), List.of(7, 8)),
				ls.split(List.of(1, 2, 3, 4, 5, 6, 7, 8)));
	}
